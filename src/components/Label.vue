<template>
  ...
  >
    <!-- Background -->
    <path
      :style="`fill: ${data.colour.background}`"
      transform="matrix(1.01977 0 0 .98525 -720.978 -503.465)"
      d="M707 511h1922v1492H707z"
    />
    ...
    <g>
      ...
      <text
        x="1105.34"
        y="950.001"
        :style="`font-family:&quot;Inter-Bold&quot;,&quot;Inter&quot;;font-weight:700;font-size:12px;fill:${data.colour.text}`"
        transform="translate(-6024.82 -5079.143) scale(5.56281)"
      >
        {{ data.text.brand }}
      </text>
      ...
      <text
        ...
        y="950.001"
        :style="`font-family:&quot;Inter-Bold&quot;,&quot;Inter&quot;;font-weight:700;font-size:12px;fill:${data.colour.text}`"
        transform="translate(-16980.334 -14295.626) scale(15.46726)"
      >
        {{ data.text.type }}
      </text>
      ...
      <text
        ...
        y="950.001"
        :style="`font-family:&quot;Inter-Bold&quot;,&quot;Inter&quot;;font-weight:700;font-size:12px;fill:${data.colour.text}`"
        transform="translate(-5759.657 -4468.44) scale(5.32225)"
      >
        Diameter
        <tspan
      ...
      >
        ...
        <tspan
          x="1192.67px 1196.31px 1203.61px"
          y="964.433px 964.433px 964.433px"
        >
          : {{ data.text.length }} m
        </tspan>
      </text>
      ...
      >
        ...
        <tspan
          x="1192.67px 1196.31px 1203.61px"
          y="978.866px 978.866px 978.866px"
        >
          : {{ data.text.temp }} ºC
        </tspan>
      </text>
      ...
      >
        ...
        <tspan
          x="1192.67px 1196.31px 1203.61px"
          y="1007.73px 1007.73px 1007.73px"
        >
          : {{ data.text.code }}
        </tspan>
      </text>
    ...
    <g transform="translate(-2288.122 -1207.29) scale(1.68735)">
      ...
      <g>
        ...
        <circle
          ...
          cy="917.043"
          r="65.731"
          :style="`fill: ${data.colour.outline}`"
          transform="translate(-2469.49 -988.288) scale(2.07769)"
        />
        ...
        <circle
          ...
          r="65.731"
          :style="`fill: ${data.colour.background}`"
          transform="translate(-2162.23 -865.325) scale(1.9436)"
        />
        ...
        <circle
          ...
          r="65.731"
          :style="`fill: ${data.colour.outline}`"
          transform="translate(-306.417 -122.628) scale(1.13372)"
        />

        <!-- Labels -->
        <path
          d="M2464.41 875.54v1.958c0 3.696-3.31 6.696-7.39 6.696h-31.32c-4.08 0-7.39-3-7.39-6.696v-1.958c0-3.696 3.31-6.696 7.39-6.696h31.32c4.08 0 7.39 3 7.39 6.696Z"
          :style="`fill: ${data.colour.outline}`"
          transform="matrix(.59508 0 0 .65685 936.963 341.305)"
        />
        <path
          d="M2298.25 1049.34v11.14c0 1.45-1.22 2.63-2.71 2.63h-64.1c-1.5 0-2.72-1.18-2.72-2.63v-11.14c0-1.45 1.22-2.63 2.72-2.63h64.1c1.49 0 2.71 1.18 2.71 2.63Z"
          :style="`fill: ${data.colour.outline}`"
          transform="matrix(.60824 0 0 .6273 914.723 360.705)"
        />
      </g>
      ...
      <text
        x="1124.25"
        y="950.001"
        :style="`font-family:&quot;Inter-Bold&quot;,&quot;Inter&quot;;font-weight:700;font-size:12px;fill:${data.colour.text};text-anchor:middle`"
        transform="translate(-1208.87 -1854.12) scale(3.11344)"
      >
        {{ data.text.colour_name }}
      </text>
      ...
      <circle
        ...
        cy="917.043"
        r="65.731"
        :style="`fill: ${data.colour.filament}`"
      />
    </g>
  </svg>
</template>
